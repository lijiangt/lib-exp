...
public class MixedMode {
    ...
    public static void main(String... args) throws Exception {
        ...
        System.out.println("jdbc:h2:tcp://localhost:9081/file:/home/lijt/test (user: analysis, password: analysisanalysis)");

        // now use the database in your application in embedded mode
        Class.forName("org.h2.Driver");
        Connection conn = DriverManager.getConnection("jdbc:h2:/home/lijt/test", "analysis", "analysisanalysis");
